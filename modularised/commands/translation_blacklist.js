// commands/translation_blacklist.js
const { SlashCommandBuilder } = require('discord.js');
const { handleTranslationBlacklist } = require('../handlers/translationBlacklistHandler');
...
module.exports = {
    ...
    async execute(interaction) {
        await handleTranslationBlacklist(interaction, interaction.client);
    },
};
